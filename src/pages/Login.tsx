    ...
    <div className="min-h-screen bg-black relative flex flex-col overflow-hidden">
      ...
      <header className="relative z-20 p-6 md:px-12">
        <div className="flex items-center space-x-2">
          <Building2 className="w-10 h-10 text-red-600 fill-current" />
          <span className="text-3xl font-black tracking-tighter text-red-600 uppercase italic">BDS PRO</span>
        </div>
      </header>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 bg-[#e50914] hover:bg-[#f40612] text-white font-bold rounded transition-colors active:scale-[0.99] disabled:opacity-50 mt-4"
            >
