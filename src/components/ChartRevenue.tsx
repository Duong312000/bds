    ...
    <div className="h-[350px]">
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={data}>
          ...
          <Area yAxisId="left" type="monotone" dataKey="revenue" name="Doanh thu" stroke="#2563eb" strokeWidth={3} fillOpacity={1} fill="url(#colorRev)" />
          <Line yAxisId="right" type="monotone" dataKey="contracts" name="Hợp đồng" stroke="#ea580c" strokeWidth={2} dot={{ r: 4 }} />
        </AreaChart>
      </ResponsiveContainer>
    </div>
  );
